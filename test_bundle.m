...
cam1 = [0.1 0.002 0.005 0 0 0 0 0];
cam2 = [0.2 0.001 0.006 0 0 0 0 0];
...
imgs = [1 0 0 87  -3/180*pi 5/180*pi 95/180*pi 1 1;
        ...
        5 50 10 87  -3/180*pi 5/180*pi 55/180*pi 2 1;
        6 10 50 56  -3/180*pi 5/180*pi 55/180*pi 2 1;
        7 50 70 70  -3/180*pi 5/180*pi 75/180*pi 2 1;
        8 55 55 50  30/180*pi 5/180*pi 55/180*pi 2 1;];

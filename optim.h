...
Eigen::VectorXd levenberg_marquardt(Eigen::VectorXd (*fn)(Eigen::VectorXd, void*), Eigen::MatrixXd (*jacobian)(Eigen::VectorXd, void*), void* params, Eigen::VectorXd x, double TolX, double TolY, optimizer_result &result);
